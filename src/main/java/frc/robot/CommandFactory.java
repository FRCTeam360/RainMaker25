...
public class CommandFactory {
  ...
  public Command teleAlignWithLimelight(
      double goalTY, double goalTX, int pipeline, CommandXboxController driverCont) {
    return CommandLogger.logCommand(
            new AlignWithLimelight(vision, drivetrain, goalTY, goalTX, pipeline, driverCont),
            "AlignWithLimelightBase")
        .andThen(
            this.alignRumble(driverCont)
  ...
  public Command pidToPoseFigure8() {
    return this.pidToPoseDriveToSetpoint(9.0, 4.0, Rotation2d.k180deg)
        .andThen(this.pidToPoseDriveToSetpoint(4.5, 7.0, Rotation2d.fromDegrees(-90.0)))
        .andThen(this.pidToPoseDriveToSetpoint(1.6, 4.0, Rotation2d.kZero))
        .andThen(this.pidToPoseDriveToSetpoint(4.0, 1.0, Rotation2d.fromDegrees(90.0)))
        .andThen(this.pidToPoseDriveToSetpoint(13.0, 7.0, Rotation2d.fromDegrees(-90.0)))
        .andThen(this.pidToPoseDriveToSetpoint(16.0, 4.0, Rotation2d.k180deg))
        .andThen(this.pidToPoseDriveToSetpoint(13.0, 1.0, Rotation2d.fromDegrees(90.0)))
        .andThen(this.pidToPoseDriveToSetpoint(9.0, 4.0, Rotation2d.k180deg));
  }

  public Command pidToPoseBlueLeft3() {
    return this.pidToPoseDriveToSetpoint(12.45, 2.77, Rotation2d.fromDegrees(60.0))
        .andThen(this.pidToPoseDriveToSetpoint(4.5, 7.0, Rotation2d.fromDegrees(-90.0)))
        .andThen(this.pidToPoseDriveToSetpoint(1.6, 4.0, Rotation2d.kZero))
        .andThen(this.pidToPoseDriveToSetpoint(4.0, 1.0, Rotation2d.fromDegrees(90.0)))
        .andThen(this.pidToPoseDriveToSetpoint(13.0, 7.0, Rotation2d.fromDegrees(-90.0)))
   ...
   * align the robot with the targetted position and then ends finally when the robot is at the
   * appropriate heading and tx/ty positions uses the coral limelight
   *
  ...
  /**
   * This aligns the robot to the target and raises the elevator to specified level and then runs
   * the coral shooter
   *
   * @param level
   * @param isLeft
  ...
  public Command alignToReefWoodbotLeft(int pipeline) {
    return new SequentialCommandGroup(
        ...
        new AlignWithLimelight(
            vision, drivetrain, -12.64, -11.16, 0, new CommandXboxController(0)));
  }
  ...
  public Command deployClimb() {
    return Commands.waitUntil(() -> (climbTimer.get() > 2.0))
        .deadlineFor(
            servo
