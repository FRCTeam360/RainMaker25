...
public final class Constants {
  public final class SetPointConstants {
    ...
    public class ElevatorHeights {
      public static final double TELE_LEVEL_FOUR =
          isCompBot() ? 29.5 - 0.3 : 29.5; // added 0.2 3/20
  ...
  public static final class PracticeBotConstants {
    ...
    public static final double TELE_RIGHT_GOAL_TY =
        10.0; // practice field: 15.5 | gpeak: 14.0 | auburn: 13.75 | dcmp: 13.75
  ...
  public static final
  class CompBotConstants { // Currently just a copy of practice bot, values should be adjusted to
    // comp if needed
    public static final String CANBUS_NAME = "Default Name";
    ...
    public static final double TELE_RIGHT_GOAL_TY =
        13.75; // practice field: 15.5 | gpeak: 14.0 | auburn: 13.75
    public static final double TELE_RIGHT_GOAL_TX = 0.0;
    public static final double TELE_LEFT_GOAL_TY = TELE_RIGHT_GOAL_TY;
    public static final double TELE_LEFT_GOAL_TX = 0.0;
