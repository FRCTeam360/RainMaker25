...
public class PathOnTheFly {
    public static class ReefPositions {
        // LEFT STARTS HERE
        public static final Map<Integer, List<Waypoint>> LeftTagIDToPosition = Map.ofEntries(
        ...
        // RIGHT STARTS HERE
        public static final Map<Integer, List<Waypoint>> RightTagIDToPosition = Map.ofEntries(
                Map.entry(
                        21,
                        PathPlannerPath.waypointsFromPoses(
                                new Pose2d(6.035, 4.005, Rotation2d.fromDegrees(-33.917)), // x & y configured in
    ...
    public static Command pathToReef(Supplier<Pose2d> currentBotPose, boolean right) {
        return Commands.either(pathToReefHelper(currentBotPose, ReefPositions.RightTagIDToPosition),
                pathToReefHelper(currentBotPose, ReefPositions.LeftTagIDToPosition), () -> right);
    }
