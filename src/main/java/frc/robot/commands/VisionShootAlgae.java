...
public class VisionShootAlgae extends Command {
  ...
  public double angleCalculator(double ty) {
    double angle =
        0.0000228102 * (Math.pow(ty, 3))
            + (0.0000216486 * Math.pow(ty, 2))
            + (0.000556059 * ty)
            + 0.0358254;
  ...
  public double setpointCalculator(double ty) {
    double setpoint =
        (0.129115 * Math.pow(ty, 3)) + (1.67316 * Math.pow(ty, 2)) + (4641.44221 + 25.0);
