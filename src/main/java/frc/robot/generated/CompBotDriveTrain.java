...
public class CompBotDriveTrain {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.12).withKI(0).withKD(0).withKS(0.2).withKV(0.124).withKA(0.006);
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.490966796875);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.358642578125);
  ...
  private static PhoenixPIDController poseXController =
      new PhoenixPIDController(1.5, 0.0, 0.05); // TODO: Find actual value
