...
public class OldCompBot {

  public static final double maxAngularRate =
      RotationsPerSecond.of(15).in(RadiansPerSecond); // 3/4 of a rotation per
  // second max angular
  // velocity
  ...
  // This needs to be tuned to your individual robot
  public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(5.87);
  ...
  private static PhoenixPIDController poseXController =
      new PhoenixPIDController(0.5, 0.0, 0.0); // TODO: Find actual value
  private static PhoenixPIDController poseYController =
      new PhoenixPIDController(0.5, 0.0, 0.0); // TODO: Find actual value
  ...
  public static CommandSwerveDrivetrain createDrivetrain() {
    poseXController.setTolerance(
        poseXControllerPositionTolerance, poseXControllerVelocityTolerance);
    poseYController.setTolerance(
        poseYControllerPositionTolerance, poseYControllerVelocityTolerance);
