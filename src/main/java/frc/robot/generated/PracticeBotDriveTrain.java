...
public class PracticeBotDriveTrain {
  ...
  public static final double maxAngularRate =
      RotationsPerSecond.of(2.0).in(RadiansPerSecond); // 3/4 of a rotation
  // per
  // second max angular
  // velocity
  ...
  public static final double strafeIRMax =
      0.05; // DOES NOTHING WE ARENT DOING INTEGRATOR RANGE :((()))
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs().withKP(0.135).withKI(0).withKD(0).withKS(0.8).withKV(0.12).withKA(0.007);
  ...
  private static final Angle kFrontLeftEncoderOffset = Rotations.of(0.360595703125);
  ...
  private static final Angle kFrontRightEncoderOffset = Rotations.of(0.3408203125);
  ...
  private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.295654296875);
  ...
  private static PhoenixPIDController poseXController =
      new PhoenixPIDController(0.95, 0.0, 0.05); // TODO: Find actual value
