...
public class CommandSwerveDrivetrain extends TunerSwerveDrivetrain implements Subsystem {
  ...
  public final Command robotCentricDrive(
    ...
    SwerveRequest.RobotCentric drive =
        new SwerveRequest.RobotCentric() // creates a fieldcentric drive
            ...
            drive
                .withVelocityX(
                    Math.pow(driveCont.getLeftY(), 3)
                        * maxSpeed
                        * -Math.signum(
                            driveCont.getLeftY())) // Drive forward with negative Y (forward)
                .withVelocityY(
                    Math.pow(driveCont.getLeftX(), 3)
                        * maxSpeed
                ...
                .withRotationalRate(
                    Math.pow(driveCont.getRightX(), 3)
                        * maxAngularRate
                        * Math.signum(
                            driveCont.getRightX())) // Drive counterclockwise with negative X
        // (left)
        );
  }
  ...
  public void periodic() {
    ...
    Logger.recordOutput(
        CMD_NAME + "Heading Controller: AtSetpoint", headingController.atSetpoint());
    Logger.recordOutput(
  ...
  //     } else if(DriverStation.getAlliance().isPresent() && DriverStation.getAlliance().get() ==
  // Alliance.Blue) {
