...
public class CoralShooter extends SubsystemBase {
  ...
  public Command antiStallIntakeCmd() {
    ...
    return CommandLogger.logCommand(waitUntilOuttakeSensor().deadlineFor(repeatOnStall()), cmdName);
  }
  ...
  public void periodic() {
    ...
    Logger.recordOutput("Coral Outtake: periodic loop time", (periodicLoopTime / 1000.0));
  }
}
