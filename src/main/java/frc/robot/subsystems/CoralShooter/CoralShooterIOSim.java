...
public class CoralShooterIOSim implements CoralShooterIO {
  ...
  private final LoggedMechanismLigament2d mech2dSide1 =
      mech2dRoot.append(new LoggedMechanismLigament2d("side1", 10, 340, 5, color));
  private final LoggedMechanismLigament2d mech2dSide2 =
      mech2dRoot.append(new LoggedMechanismLigament2d("side2", 5, 270, 5, color));
  private final LoggedMechanismLigament2d mech2dSide3 =
