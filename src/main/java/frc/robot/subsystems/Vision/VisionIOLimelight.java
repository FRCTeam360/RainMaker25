...
public class VisionIOLimelight implements VisionIO {
  ...
  public VisionIOLimelight(
      ...
      DoubleSupplier gryoAngleRateSupplier,
   ...
   */
  public VisionIOLimelight(
      String name, DoubleSupplier gyroAngleSupplier, DoubleSupplier gryoAngleRateSupplier) {
    table = NetworkTableInstance.getDefault().getTable(name);
    this.name = name;
    this.gyroAngleSupplier = gyroAngleSupplier;
    this.gryoAngleRateSupplier = gryoAngleRateSupplier;
  ...
  public void updateInputs(VisionIOInputs inputs) {
    ...
    if (inputs.tv == 0.0
        || newPoseEstimate.isEmpty()
        || gryoAngleRateSupplier.getAsDouble() > 720.0) return;
